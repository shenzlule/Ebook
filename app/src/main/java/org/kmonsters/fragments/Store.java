...
import org.kmonsters.models.ProductModel;
            ...
            if (pdfFiles != null) {
                for (String pdfFile : pdfFiles) {
                    ...
                    if (pdfFile.toLowerCase().endsWith(".pdf")) {
                        ...
                        pdfItems.add(new PdfItem(name, path,randomPrice));
                        Helper.add_item(new PdfItem(name, path,randomPrice));
