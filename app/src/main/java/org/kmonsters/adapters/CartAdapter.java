...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.PdfViewHolder> {
    ...
    private List<PdfItem> filteredPdfItems;

    public CartAdapter(Context context, List<PdfItem> pdfItems) {
    ...
    public void onBindViewHolder(@NonNull PdfViewHolder holder, int position) {
        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PdfItem selectedPdf = pdfItems.get(holder.getAdapterPosition());
    ...
    public void filterList(List<PdfItem> filteredList) {
